...
/**
 * Analyzes a screenshot (base64) of a conversation.
 */
...
/**
 * Provides coaching on specific text.
 */
...
/**
 * Generates 3 objective daily quests related to APP USAGE.
 */
export const getDailyQuests = async (): Promise<DailyQuest[]> => {
  ...
  // Return cached quests if they are from today
  if (cached && cachedDate === today) {
    return JSON.parse(cached);
  }

  // Predefined App Usage Quests
