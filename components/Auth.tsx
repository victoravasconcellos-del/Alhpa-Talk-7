...
const Auth: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-black flex flex-col relative overflow-y-auto">
                ...
                <div className="p-6 overflow-y-auto custom-scrollbar text-sm text-zinc-300 space-y-4 leading-relaxed flex-1 bg-zinc-900">
                    {legalModal === 'TERMS' ? (
                        <>
                            ...
                            <p><strong className="text-white block mb-1">2. Isenção de Responsabilidade (Disclaimer)</strong> O AlphaTalk é uma ferramenta de entretenimento e educação social. As análises de conversas e sugestões de respostas são geradas automaticamente por modelos de IA e podem conter imprecisões. 
                            <br/><br/>
                            <span className="text-red-400/90 bg-red-950/30 px-2 py-0.5 rounded border border-red-500/20 inline-block text-xs font-bold uppercase tracking-wide">IMPORTANTE</span><br/>
                            O AlphaTalk <strong>não garante</strong> resultados específicos em relacionamentos, encontros ou interações sociais. Não nos responsabilizamos por términos, rejeições ou mal-entendidos resultantes do uso das sugestões do aplicativo. Você é o único responsável por suas ações e mensagens enviadas.</p>
                            
                            <p><strong className="text-white block mb-1">3. Conduta do Usuário</strong> É estritamente proibido utilizar o AlphaTalk para:
                            <ul className="list-disc pl-5 mt-1 space-y-1 text-zinc-400">
                                <li>Gerar conteúdo de assédio, discurso de ódio, ameaças ou discriminação.</li>
                                <li>Manipular ou enganar terceiros de forma maliciosa.</li>
                                <li>Analisar conversas que envolvam atividades ilegais ou exploração de menores.</li>
                            </ul>
                            </p>
                        </>
                    ) : (
                        <>
                            ...
                            <p><strong className="text-white block mb-1">1. Coleta de Dados</strong> Para o funcionamento do serviço, coletamos:
                            <ul className="list-disc pl-5 mt-1 space-y-1 text-zinc-400">
                                <li>E-mail e Nome (para autenticação e perfil).</li>
                                <li>Dados de uso (frequência de acesso, XP, conquistas).</li>
                                <li>Conteúdo enviado (prints e textos) para processamento momentâneo.</li>
                            </ul>
                            </p>

                            <p><strong className="text-white block mb-1">2. Processamento de Imagens e IA</strong> As imagens (screenshots) que você envia para a função "Scanner IA" são transmitidas de forma criptografada para a API do Google Gemini para extração de texto e análise de contexto. 
                            <br/><br/>
                            O AlphaTalk armazena o histórico das análises localmente no seu dispositivo e/ou de forma vinculada à sua conta segura. Não vendemos suas conversas privadas para terceiros.</p>

                            <p><strong className="text-white block mb-1">3. Seus Direitos (LGPD)</strong> Você tem o direito de:
                            <ul className="list-disc pl-5 mt-1 space-y-1 text-zinc-400">
                                <li>Solicitar o acesso a todos os dados que temos sobre você.</li>
                                <li>Solicitar a correção de dados incompletos ou inexatos.</li>
                                <li>Solicitar a exclusão total da sua conta e dados associados a qualquer momento.</li>
                            </ul>
                            </p>
                        </>
                    )}
      ...
      {/* Footer Legal Links - Explicit, Visible and Compliant */}
